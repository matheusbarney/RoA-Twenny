...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_absa_new_whip2"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HEIGHT, 112);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, asset_get("sfx_absa_uair"));
