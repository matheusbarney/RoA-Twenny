...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, thunder_small);
...
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT, thunder_small);
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, sound_get("zap"));
set_hitbox_value(AT_USTRONG, 4, HG_TWENNY_ELECTRIC, 1);
...
set_hitbox_value(AT_USTRONG, 5, HG_VISUAL_EFFECT, thunder_small);
...
set_hitbox_value(AT_USTRONG, 6, HG_HITBOX_GROUP, 8);
...
set_hitbox_value(AT_USTRONG, 6, HG_HITBOX_Y, -47);
set_hitbox_value(AT_USTRONG, 6, HG_WIDTH, 72);
set_hitbox_value(AT_USTRONG, 6, HG_HEIGHT, 72);
set_hitbox_value(AT_USTRONG, 6, HG_PRIORITY, 2);
set_hitbox_value(AT_USTRONG, 6, HG_DAMAGE, 5);
set_hitbox_value(AT_USTRONG, 6, HG_ANGLE, 70); 
set_hitbox_value(AT_USTRONG, 6, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_USTRONG, 6, HG_KNOCKBACK_SCALING, 1.2);
set_hitbox_value(AT_USTRONG, 6, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_USTRONG, 6, HG_HITPAUSE_SCALING, .5);
set_hitbox_value(AT_USTRONG, 6, HG_ANGLE_FLIPPER, 3);
set_hitbox_value(AT_USTRONG, 6, HG_VISUAL_EFFECT, thunder_big);
set_hitbox_value(AT_USTRONG, 6, HG_HIT_SFX, sound_get("shothurt"));
set_hitbox_value(AT_USTRONG, 6, HG_TWENNY_ELECTRIC, 1);