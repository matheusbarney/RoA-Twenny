...
set_attack_value(AT_EXTRA_2, AG_AIR_SPRITE, sprite_get("uspecial"));
...
set_window_value(AT_EXTRA_2, 1, AG_WINDOW_SFX, asset_get("sfx_ell_eject"));
...
set_window_value(AT_EXTRA_2, 2, AG_WINDOW_CUSTOM_GRAVITY, 0.2);
...
set_window_value(AT_EXTRA_2, 4, AG_WINDOW_CUSTOM_GRAVITY, 0.2);

set_num_hitboxes(AT_EXTRA_2, 2);

// claw
set_hitbox_value(AT_EXTRA_2, 1, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_EXTRA_2, 1, HG_WINDOW, 999);
...
set_hitbox_value(AT_EXTRA_2, 1, HG_PROJECTILE_SPRITE, sprite_get("empty_sprite"));
...
set_hitbox_value(AT_EXTRA_2, 1, HG_PROJECTILE_DESTROY_EFFECT, HFX_GEN_SWEET);
...
set_hitbox_value(AT_EXTRA_2, 2, HG_HITBOX_Y, 0);
set_hitbox_value(AT_EXTRA_2, 2, HG_WIDTH, 50);
set_hitbox_value(AT_EXTRA_2, 2, HG_HEIGHT, 28);
...
set_hitbox_value(AT_EXTRA_2, 2, HG_BASE_HITPAUSE, 18); 
